...
import de.tomson124.buildingguide.network.MethodEntry;
...
public abstract class CommonRegistryCallbacks<T, E extends IForgeRegistryEntry<E>> implements IForgeRegistry.AddCallback<E>, IForgeRegistry.ClearCallback<E>, IForgeRegistry.CreateCallback<E> {
	...
	private static final ResourceLocation OBJECT_TO_ENTRY = BuildingGuide.location("object_to_entry");

	private static final ResourceLocation ENTRY_TO_ID = BuildingGuide.location("entry_to_id");
